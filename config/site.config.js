...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'inifikryhere@inifikry.onmicrosoft.com',
  ...
  baseDirectory: '/Eo5QYcEvytZAvE7zdT8P5cwBi9eGpinU8DufKDmKJsqplg?e=efXfJZ',
